...
WSGI_APPLICATION = 'budgetscope.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'budgetscope'),
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=int(os.getenv('JWT_EXPIRATION_DELTA', 7)) + 7),
